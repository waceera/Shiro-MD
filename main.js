...
const {
    ...
    PHONENUMBER_MCC,
    Browsers
} = await (await import('baileys')).default;
...
if (global.pairingCode && !conn.authState.creds.registered) {
    ...
    console.error("Mohon Masukkan Nomor Yang Akan Dijadikan Bot Di Config Terlebih Dahulu");
}
...
global.reloadHandler = async function(restatConn) {
    ...
    conn.welcome = 'Selamat datang di @subject, @user\n'
