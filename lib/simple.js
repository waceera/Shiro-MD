...
END:VCARD
    ...
    **/
     value(jid, text = '', budyy = '', badi = '', minaj = true, saus = '', url = '', valuw = true, quoted, options) {
      conn.sendMessage(jid, { text: text, contextInfo:
					{
						"externalAdReply": {
							"title": budyy,
							"body": badi,
							"showAdAttribution": minaj,
                            "mediaType": 1,
							"sourceUrl": saus,
							"thumbnailUrl": url,
							"renderLargerThumbnail": valuw
...
let pathFile1 = await writeExif(media, { packname: options.packname ? options.packname : 'Veikone ~~', author: options.author ? options.author : '', categories: options.categories ? options.categories : [] })
...
export function serialize() {
    ...
    return Object.defineProperties(proto.WebMessageInfo.prototype, {
        ...
        isBaileys: {
        get() {
        return this.id.startsWith('3EB0') || this.id.startsWith('BAE5');
         }
       },
        chat: {
            get() {
